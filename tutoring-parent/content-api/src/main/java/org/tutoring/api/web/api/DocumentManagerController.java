...
import org.tutoring.api.service.DocumentManagerService;
...
public class DocumentManagerController extends BaseController {
    ...
    @RequestMapping(value = "/api/documentManager",method = RequestMethod.GET,produces = MediaType.APPLICATION_JSON_VALUE)

    public Collection<DocumentManager> getAll() throws InvalidDataException {
    ...
    @RequestMapping(
            value = "/api/documentManager/{id}",
            method = RequestMethod.GET,
            produces = MediaType.APPLICATION_JSON_VALUE
    )
    public DocumentManager get(@PathVariable("id") Long id) throws InvalidDataException, InvalidInputException, NullDataException {
    ...
    @RequestMapping(
            value = "/api/documentManager",
            method = RequestMethod.POST,
            consumes = MediaType.APPLICATION_JSON_VALUE,
            produces = MediaType.APPLICATION_JSON_VALUE
    )
    public DocumentManager create(@RequestBody DocumentManager documentManager) throws InvalidDataException, DatabaseUpdateException, NullDataException {

        if(documentManager.getFileId() <=0 || documentManager.getFilePath() == null || documentManager.getDocumentFormat() == null ||
                documentManager.getDocumentTitle() == null || documentManager.getDocumentAuthor() == null) {
            throw new DatabaseUpdateException(APIMessages.DATABASE_UPDATE_FAIL);
        }
        else{
            return service.create(documentManager);
        }
    }
    ...
    public DocumentManager update(@RequestBody DocumentManager documentManager, @PathVariable("id") Long id) throws InvalidDataException, InvalidInputException, NullDataException, DatabaseUpdateException {
        ...
        if (id == null) {
            ...
            if (service.findOne(id) != null) {
                return service.update(documentManager);
            } else {
                throw new DatabaseUpdateException(APIMessages.DATABASE_UPDATE_FAIL);
            }
        }
