...
import org.tutoring.api.service.HistoryService;
...
public class HistoryController extends BaseController {
    ...
    public Collection<History> getAll() throws InvalidDataException {
    ...
    @RequestMapping(
            value = "/api/history/{id}",
            method = RequestMethod.GET,
            produces = MediaType.APPLICATION_JSON_VALUE
    )
    public History get(@PathVariable("id") Long id) throws InvalidDataException, InvalidInputException, NullDataException {
    ...
    public History create(@RequestBody History history) throws InvalidDataException, DatabaseUpdateException, NullDataException {
    ...
    public History update(@RequestBody History history, @PathVariable("id") Long id) throws InvalidDataException, InvalidInputException, NullDataException, DatabaseUpdateException {
