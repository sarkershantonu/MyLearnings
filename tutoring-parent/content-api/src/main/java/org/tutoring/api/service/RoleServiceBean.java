...
public class RoleServiceBean implements RoleService {
    ...
    @Override
    public Collection<Role> viewAll() throws InvalidDataException {
        try {
    ...
    @Override
    public Role findOne(Long id) throws NullDataException, InvalidDataException, InvalidInputException {
        if (null == id) {
    ...
    public Role create(Role aRole) throws NullDataException, InvalidDataException, DatabaseUpdateException {
        if (null == aRole) {
    ...
    @Override
    @Transactional(propagation = Propagation.REQUIRED, readOnly = false)
    public Role update(Role aRole) throws InvalidDataException, NullDataException, DatabaseUpdateException {
        if (null == aRole) {
            throw new NullDataException(DATA_NULL);
        }
        try {
            if (findOne(aRole.getId()) != null) {
                return roleRepository.save(aRole);
            } else {
    ...
    @Override
    @Transactional(propagation = Propagation.REQUIRED, readOnly = false)
    public Long delete(Long id) throws DatabaseUpdateException, NullDataException {
